...
define('ZABBIX_HOSTNAME', 'mq1');

// RabbitMQ Configuration
define('API_HOSTNAME', 'mq1@mq1');
...
//		write_to_data_file('message.get', $data->message_stats->get);
		...
		// Send data to zabbix
		exec("/opt/zabbix/bin/zabbix_sender -vv -z manager.networkbench.com -i $data_file_name 2>&1", $log_file_data);
